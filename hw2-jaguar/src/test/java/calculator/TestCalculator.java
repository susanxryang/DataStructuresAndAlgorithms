...
public class TestCalculator extends BaseTest {
    ...
    public void basicTestToDouble() {
        ...
        assertEquals("5", calc.evaluate("toDouble(3 + 2)"));
    }
    
    @Test(timeout=SECOND)
    public void basicTestSimplify() {
        Calculator calc = new Calculator();
    ...
    @Test(timeout=SECOND)
    public void testSimplifyArithmeticOperators() {
        Calculator calc = new Calculator();
    ...
    @Test(timeout=SECOND)
    public void testSimplifyTrigOperators() {
        Calculator calc = new Calculator();
    ...
    @Test(timeout=SECOND)
    public void testToDoubleOnUndefinedThrowsException() {
        Calculator calc = new Calculator();
        try {
    ...
    @Test(timeout=SECOND)
    public void testSimplifyTallAst() {
        Calculator calc = new Calculator();
        assertEquals("2 + a + 8", calc.evaluate("1 + 1 + a + 2 * 4"));
        assertEquals("2 * (a + 4)", calc.evaluate("(1 + 1) * (a + 2 * (1 + 1))"));
    }

    @Test(timeout=SECOND)
    public void testSimplifyDoesNotMutateVariables() {
        Calculator calc = new Calculator();
        calc.evaluate("y := x + 5");
        assertEquals("1", calc.evaluate("x := 1"));
    ...
    @Test(timeout=SECOND)
    public void testPlotOnUndefinedThrowsException() {
        Calculator calc = new Calculator();
        calc.setImageDrawer(new FakeImageDrawer());
    ...
    @Test(timeout=SECOND)
    public void testPlotOnInvalidInputThrowsException() {
        Calculator calc = new Calculator();
        calc.setImageDrawer(new FakeImageDrawer());
    ...
    @Test(timeout = SECOND)
    public void testPlotOnSinAndExpo() {
        Calculator calc = new Calculator();
        calc.setImageDrawer(new FakeImageDrawer());

        try {
            calc.evaluate("plot(sin(x), x, 10, 0, 1)");
            fail("Expected EvaluationError");
        } catch (EvaluationError err) {
            // Do nothing
        }
        ...
        try {
            calc.evaluate("plot(x^2, x, 0, 10, -11)");
            fail("Expected EvaluationError");
        } catch (EvaluationError err) {
            // Do nothing
        }
        ...
        calc.evaluate("x := 3");
        try {
            calc.evaluate("plot(x^2+sin(x), x, 0, 10, -11)");
            fail("Expected EvaluationError");
        } catch (EvaluationError err) {
            // Do nothing
        }
